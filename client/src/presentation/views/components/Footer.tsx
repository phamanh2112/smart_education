        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 max-w-sm leading-relaxed">
              Empowering the future of education through smart technology. Connecting teachers and students worldwide.
            </p>
            <div className="flex gap-4 mt-6">
              {['𝕏', 'in', 'f', '📺'].map((icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center text-sm hover:bg-white/20 transition-all hover:scale-110">
                  {icon}
                </a>
              ))}
            </div>
